...
def import_stock_locations(backend):
    try:
        ...
        backend.create_log_entry_async(LogSeverity.Error, f"Error while in function import_stock_locations()", ex)
...
def import_stocks(backend):
    try:
        ...
        backend.create_log_entry_async(LogSeverity.Error, f"Error while in function import_stocks()", ex)
